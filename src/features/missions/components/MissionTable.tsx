import { Trash2, CheckCircle, PlayCircle, AlertCircle, Clock, FileText } from 'lucide-react';
                        ...
                        missions.map((mission) => (
                            <tr key={mission.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">
                                    <div className="font-mono text-xs">{truncateId(mission.droneId)}</div>
                                </td>
                                ...
                                <td className="px-6 py-4 text-sm">
                                    {mission.hasRoute ? (
                                        ...
                                        <div className="flex items-center gap-1 text-gray-400 dark:text-gray-500">
                                            ...
                                            <span className="text-xs">Sin ruta</span>
                                        </div>
                                    )}
                                </td>
